...
Lets build out the measurement model to include all exogeneous and endogeneous variables in the theoretical model.
```{r}
...
#get model info, commonly accepted thresholds
#CFI = .96
#TLI =.94
#RMSEA = .09
...
If the preceeding CFA indicate acceptable results, then continue expanding the model with directional regression analyses, i.e. the structural model, again according to the theoretical model.
```{r}
